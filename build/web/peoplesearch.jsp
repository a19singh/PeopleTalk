    ...
    <body data-spy="scroll" data-target="#my-navbar">
        ...
        <div class="container">
            <section>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <!--<img src="GetPhoto?email=<%=peopleDetails.get("email")%>">-->
                    </div>
                    <div class="col-lg-7">
                        <div class="form-group">
                            <label for="email" class="control-label">Name: <font color="grey"><%=peopleDetails.get("name")%></font></label><br>
                            <label for="name" class="control-label">Email:<font color="grey"> <%=peopleDetails.get("email")%></font></label><br>
